...
function ControlledCarousel() {
  ...
  return (
    <Carousel activeIndex={index} onSelect={handleSelect}>
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaOne} height="700px" width="800px" text="1 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaTwo}  height="700px" width="800px" text="2 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaFive} height="700px" width="800px" text="3 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaThree} height="700px" width="800px" text="4 slide" alt="pic"/>
        <Carousel.Caption>
        ...
        <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaFour} height="700px" width="800px" text="5 slide" alt="pic"/>
        <Carousel.Caption>
...
Alla knows how to present any information in such a way that it becomes very interesting</p>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaSix} height="700px" width="800px" text="6 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaSeven} height="700px" width="800px" text="7 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaEight} height="700px" width="800px" text="8 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaNine} height="700px" width="800px" text="9 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaTen} height="700px" width="800px" text="10 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaEleven} height="700px" width="800px" text="11 slide" alt="pic"/>
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img className='carouselAlla photoFrame' src={allaTwelve} height="700px" width="800px" text="12 slide" alt="pic"/>
        <Carousel.Caption>
